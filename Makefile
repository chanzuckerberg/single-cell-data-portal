...
# under python_dependecies.
#. The first
# requirements file will be name requirements.txt and include evreything in tool.poetry.dependencies. The second
# requirements file will be name requirement-dev.txt and will inlcude everything under tool.poetry.group.dev.dependencies.
poetry/requirements.txt:
	@echo "Generating requirements.txt"
	@echo "# This file is generated by make requirements.txt" > requirements.txt
	@echo "# Do not edit this file directly" >> requirements.txt
	@echo "" >> requirements.txt
	@echo "# This file is generated by make requirements-dev.txt" > requirements-dev.txt
