...
def s3_snapshot():
    ...
    return WmgSnapshot(snapshot_identifier="",
                       expression_summary_cube=tiledb_open_s3_uri('s3://cellxgene-wmg-staging/snapshots/v3/1702836210/expression_summary'),
                       expression_summary_default_cube=tiledb_open_s3_uri('s3://cellxgene-wmg-staging/snapshots/v3/1702836210/expression_summary_default'))
