...
class OldLibraryPrepProtocol:
    ...
    def populate_from_dcp_one_json_data_frame(self, row):
        self.input_nucleic_acid_molecule_ontology = row.get("input_nucleic_acid_molecule_ontology.ontology")
        self.library_construction_method_ontology = row.get("library_construction_method.ontology")
    ...
    def set_cell_suspension(self, cell_suspension: OldCellSuspension):
        if self.cell_suspension and self.cell_suspension.corresponding_old_id != cell_suspension.corresponding_old_id:
            logging.log(
                logging.WARNING,
    ...
    def to_dictionary(self):
        ...
        dictionary_representation["cell_suspension"] = self.cell_suspension.corresponding_old_id
        return dictionary_representation

    def convert_to_new_entity(self):
        library_prep_id = hca_accession_transformer(LibraryPrepProtocol.__name__, self.corresponding_old_id)
