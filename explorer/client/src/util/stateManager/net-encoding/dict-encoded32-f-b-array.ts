...
export class DictEncoded32FBArray {
  bb: flatbuffers.ByteBuffer | null = null;
  bb_pos = 0;
  __init(i: number, bb: flatbuffers.ByteBuffer): DictEncoded32FBArray {
    this.bb_pos = i;
    this.bb = bb;
    return this;
  }

  static getRootAsDictEncoded32FBArray(
    bb: flatbuffers.ByteBuffer,
    obj?: DictEncoded32FBArray,
  ): DictEncoded32FBArray {
    return (obj || new DictEncoded32FBArray()).__init(
      bb.readInt32(bb.position()) + bb.position(),
      bb,
    );
  }

  static getSizePrefixedRootAsDictEncoded32FBArray(
    bb: flatbuffers.ByteBuffer,
    obj?: DictEncoded32FBArray,
  ): DictEncoded32FBArray {
  ...
  static startDictEncoded32FBArray(builder: flatbuffers.Builder) {
  ...
  static endDictEncoded32FBArray(
    builder: flatbuffers.Builder,
  ): flatbuffers.Offset {
  ...
  static createDictEncoded32FBArray(
    builder: flatbuffers.Builder,
    codesOffset: flatbuffers.Offset,
    dictOffset: flatbuffers.Offset,
  ): flatbuffers.Offset {
    DictEncoded32FBArray.startDictEncoded32FBArray(builder);
    DictEncoded32FBArray.addCodes(builder, codesOffset);
    DictEncoded32FBArray.addDict(builder, dictOffset);
    return DictEncoded32FBArray.endDictEncoded32FBArray(builder);
  }
}
