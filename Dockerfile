...
RUN apt-get update && \
    apt-get install -y python3 libhdf5-dev python3-h5py graphviz graphviz-dev gettext moreutils build-essential libxml2-dev python3-dev python3-pip zlib1g-dev python3-requests python3-aiohttp llvm jq && \
