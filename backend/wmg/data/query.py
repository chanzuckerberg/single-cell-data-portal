...
class WmgQuery:
    ...
    def execute(self, criteria: WmgQueryCriteria) -> DataFrame:
        ...
        # TODO: Benchmark whether this fast than just doing all the attribute filtering in Pandas
        ...
        return (
            query_result_df
            .groupby(["gene_ontology_term_id", "tissue_ontology_term_id", "cell_type_ontology_term_id"])
            .sum()
        )
