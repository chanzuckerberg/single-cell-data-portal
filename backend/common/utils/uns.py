...
class SpatialDataProcessor:
    def __init__(self, s3_provider: S3Provider = S3Provider()):
    ...
    def _process_and_flip_image(self, image_array_uint8):
        ...
        # Convert the numpy array to a PIL Image, process, and immediately convert back to a numpy array
