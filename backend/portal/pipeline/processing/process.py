...
from backend.portal.pipeline.processing.common import update_db
...
def main():
    ...
    try:
        if step_name == "download-validate":
            ...
            from backend.portal.pipeline.processing.process_cxg import process
            ...
            try:
                from backend.portal.pipeline.processing.remaster_cxg import process
