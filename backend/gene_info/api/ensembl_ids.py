...
class GeneChecker:
    ...
    def is_valid_label(self, gene_label: str) -> bool:
        """
        Checks if gene name is in dictionary

        :param str gene_label: human-readable gene symbol

        :rtype bool
        :return True if the gene_label is a valid gene name, False otherwise
        """

        return gene_label in GeneChecker.gene_dict
    ...
    def get_id(self, gene_label) -> str:
        ...
        if not self.is_valid_label(gene_label):
