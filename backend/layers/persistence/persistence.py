...
class DatabaseProvider(DatabaseProviderInterface):
    ...
    def _drop_schema(self):
        ...
        with contextlib.suppress(ProgrammingError):
            self._engine.connect(close_with_result=True).execute(DropSchema(self._schema_name, cascade=True))
    ...
    def _create_schema(self):
        ...
        self._engine.connect(close_with_result=True).execute(CreateSchema(self._schema_name))
