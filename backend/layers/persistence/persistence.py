...
class DatabaseProvider(DatabaseProviderInterface):
    ...
    def _row_to_collection_version(self, row: Any, canonical_collection: CanonicalCollection) -> CollectionVersion:
        ...
        return CollectionVersion(
            ...
            publisher_metadata=None if row.publisher_metadata is None else row.publisher_metadata,
    ...
    def artifact_exists(self, artifact_id: DatasetArtifactId) -> bool:
        ...
        """
        with self._manage_session() as session:
            artifact = session.query(DatasetArtifactTable).filter_by(id=artifact_id.id).one_or_none()
