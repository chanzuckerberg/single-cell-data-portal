...
# Sync S3 data from production environment to a specified destination environment
...
S3_SYNC_CMD="aws s3 sync --copy-props metadata-directive --no-progress --dryrun"
