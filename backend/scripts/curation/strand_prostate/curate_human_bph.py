...
def remix(adata, title: str):
    ...
    disease_ontology_map = {"BPH": "MONDO:0010811", "Normal": "PATO:0000461"}
    ...
    adata.uns["project_raw_data_links"] = ["https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE145928"]
    ...
    cell_type_ontology_map = {"BE": "CL:0002341", "Club": "NA", "Hillock": "NA", "LE": "CL:0002340", "NE": "CL:0002313"}
