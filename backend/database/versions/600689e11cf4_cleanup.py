...
def upgrade():
    ...
    op.drop_table('child')
    op.alter_column('geneset_dataset_link', 'dataset_id',
               existing_type=sa.VARCHAR(),
               nullable=True)
    op.alter_column('geneset_dataset_link', 'geneset_id',
               existing_type=sa.VARCHAR(),
               nullable=True)
...
def downgrade():
    ...
    op.create_table('associate_property_owner',
    sa.Column('id', sa.VARCHAR(), autoincrement=False, nullable=False),
    ...
    op.create_index('ix_associate_property_owner_property_id', 'associate_property_owner', ['property_id'], unique=False)
