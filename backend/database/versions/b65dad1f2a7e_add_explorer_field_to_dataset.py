...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('deployment_directory',
                    ...
                    sa.ForeignKeyConstraint(['dataset_id'], ['dataset.id'],
                                            name='deployment_directory_dataset_id_fkey'),
                    sa.PrimaryKeyConstraint('id', name='deployment_directory_pkey')
                    )
    op.execute('CREATE EXTENSION IF NOT EXISTS "uuid-ossp";')
    op.execute("INSERT into deployment_directory (id, dataset_id, url, created_at, updated_at) SELECT uuid_generate_v4(), id, explorer_url, NOW(), NOW() FROM dataset WHERE dataset.explorer_url is not null;")
