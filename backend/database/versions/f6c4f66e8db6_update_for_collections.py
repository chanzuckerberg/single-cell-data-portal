...
def downgrade():
    ...
    op.execute("UPDATE project SET project_status = 'LIVE' WHERE visibility = 'PUBLIC'")
    op.execute("UPDATE project SET project_status = 'EDIT' WHERE visibility = 'PRIVATE'")
    ...
    op.execute("DROP TYPE collectionvisibility;")
    # ### end Alembic commands ###
