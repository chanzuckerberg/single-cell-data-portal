...
class OpenAIProvider:
    def __init__(self, model_name="gpt-4-turbo-2024-04-09", fallback_model_name="gpt-4") -> None:
        self.organization = GeneGuideConfig().openai_organization_id
        self.api_key = GeneGuideConfig().openai_api_key
