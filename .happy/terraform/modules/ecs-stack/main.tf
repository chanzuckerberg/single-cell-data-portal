...
locals {
  ...
  backend_de_listener_arn         = try(local.secret[local.alb_key]["backend-de"]["listener_arn"], "")
  backend_wmg_listener_arn         = try(local.secret[local.alb_key]["backend-wmg"]["listener_arn"], "")
  ...
  backend_de_alb_zone             = try(local.secret[local.alb_key]["backend-de"]["zone_id"], "")
  backend_wmg_alb_zone             = try(local.secret[local.alb_key]["backend-wmg"]["zone_id"], "")
  ...
  backend_de_alb_dns              = try(local.secret[local.alb_key]["backend-de"]["dns_name"], "")
  backend_wmg_alb_dns              = try(local.secret[local.alb_key]["backend-wmg"]["dns_name"], "")
...
module upload_sfn {
  ...
  atac_job_definition    = module.upload_batch.atac_job_definition
