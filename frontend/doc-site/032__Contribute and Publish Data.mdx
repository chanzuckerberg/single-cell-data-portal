...
Cellxgene supports a rapidly growing single cell data corpus because of generous contributions from researchers like you! If you have single cell data that meet our [requirements](#dataset-requirements), please reach out to our curation team at [cellxgene@chanzuckerberg.com](cellxgene@chanzuckerberg.com).

## Publishing Process

The process for submission to the portal is:
- You confirm we can support your submission by reaching out to our curation team at [cellxgene@chanzuckerberg.com](cellxgene@chanzuckerberg.com) with a description of the data that you'd like to contribute.
...
To maximize downstream reuse and visualization, datasets submitted to the Cellxgene Data Portal must be formatted as an AnnData v0.7 file and contain the information required in its [schema](https://github.com/chanzuckerberg/single-cell-curation/blob/main/schema/2.0.0/schema.md#schema). Additional metadata that are relevant to the dataset may also be submitted. This section briefly summarizes the metadata that must be submitted:
