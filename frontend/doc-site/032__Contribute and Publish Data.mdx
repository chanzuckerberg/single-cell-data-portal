...
CELLxGENE supports a rapidly growing single cell data corpus because of generous contributions from researchers like you! Please see below for If you have single-cell data that meet our [requirements](#dataset-requirements), please reach out to our curation team at [cellxgene@chanzuckerberg.com](mailto:cellxgene@chanzuckerberg.com).

## Publishing Process

1. To confirm we can support your submission, please [contact us] with a description of the data that you'd like to contribute
2. We confirm that we will accept your data
3. You send us files prepared according to the submission [requirements](#dataset-requirements)
...
CELLxGENE supports most single-cell RNA-seq and ATAC-seq data, but there are a few types of data that we are **not** likely to accept at this time:
...
- species not on the [supported list](https://chanzuckerberg.github.io/single-cell-curation/latest-schema.html#organism_ontology_term_id)
  - CELLxGENE continues to expand support so please [contact us] to discuss possible inclusion of additional organisms
- assays not on the [supported list](https://github.com/chanzuckerberg/cellxgene-census/blob/main/docs/census_accepted_assays.csv)
  ...
  - CELLxGENE continues to expand support so please [contact us] to discuss possible inclusion of additional assays
...
- **Cell metadata in obs** (ontology term IDs MUST be the most specific term available from the specified ontology):
  ...
  - **development_stage_ontology_term_id**
    ...
    - zebrafish [ZFS](https://www.ebi.ac.uk/ols4/ontologies/zfs)
    - fruit fly [WRONG](https://www.ebi.ac.uk/ols/ontologies/hsapdv)
