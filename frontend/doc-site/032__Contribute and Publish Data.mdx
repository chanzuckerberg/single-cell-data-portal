...
- **Additional genetic perturbation standards**
  ...
  - **obs['genetic_perturbation_strategy']**
    - `control`, `CRISPR activation screen`, `CRISPR interference screen`, `CRISPR knockout mutant`, or `CRISPR knockout screen`
    - `na` if corresponding genetic_perturbation_id is `na`
