...
5. We upload to a private Collection where you can review
6. The submission can be revised, as needed
7. The data are made openly available when you are ready
