# Load, Create, and Export Gene Sets
...
To read more about how to use gene sets in the cellxgene interface, please see [Exploring Gene Expression](../explore-data/how-to-explore-data.md#explore-gene-expression)
...
The cellxgene gene set data format is a [_Tidy_ CSV](https://github.com/chanzuckerberg/cellxgene-documentation/tree/e89e399fdf32e698fc8e773212b598a196e0bad3/desktop/gene_sets_example.csv) \(comma-separated values\) file using ASCII encoding. Multiple gene sets MAY be included in the file.
