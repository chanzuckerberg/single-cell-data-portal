...
ScExpression allows for exploration of gene expression by cell type across all data sets in the CELLxGENE Discover data corpus. It is currently in beta.
