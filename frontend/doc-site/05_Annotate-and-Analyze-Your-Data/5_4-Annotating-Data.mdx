...
As described in the hosted LINK TO THE HOSTED SECTION section, we do not officially support hosted or multi-user use of cellxgene. However, we recognize that the app is often adapted for this purpose, and have tried to provide a "safe path" for multi-user setups that avoids overwriting data.
...
`cellxgen`e autosaves any changes made to your annotations every 3 seconds.
...
Wonderful! We would love to hear your feedback :) CAN WE MAKE THIS POPULATE AN EMAIL TO CELLXGENE@CHANZUCKERBERG.COM
