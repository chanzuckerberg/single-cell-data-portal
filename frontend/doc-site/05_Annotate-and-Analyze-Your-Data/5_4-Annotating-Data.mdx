...
<Image src={"/doc-site/5-4_annotate_data.png"} height={250} />
...
_Specify an annotations CSV_

_This mode is only appropriate for single-user, local cellxgene instances._
...
_I keep getting weird index errors when trying to join my annotations to my anndata?_
...
_How do you remember my unique ID to match my cellxgene session with my annotations file?_
...
_I have feedback and ideas for you!_
