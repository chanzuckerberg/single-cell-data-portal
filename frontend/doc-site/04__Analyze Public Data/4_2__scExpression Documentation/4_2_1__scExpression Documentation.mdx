...
<p align="center">
  ...
  <br />
  <b>Figure 1.</b> Two metrics are represented in gene expression dot plots,
  gene expression and percentage of expressing cells.
</p>
...
<p align="center">
  <img
    src="./files/illustration_expression_levels.png"
    width="783"
    height="433"
  />
  <br />
...
<p align="center">
  <img
    src="./files/illustration_parent_children.png"
    width="613"
    height="263"
  />
  <br />
  <b>Figure 4.</b> In some cases parent and children cell types are present, but
...
<p align="center">
  ...
  <b>Figure 5. </b> Overview of processing steps from raw read counts to gene expression
  averages per cell type.
</p>
