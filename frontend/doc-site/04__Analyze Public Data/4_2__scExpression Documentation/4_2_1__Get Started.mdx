...
scExpression is a tool that allows to query the expression of any gene across all data in the cellxgene data portal. A query results in a dot plot per tissue as explained below.
