...
1. Standard analysis: 0.35
2. Marker gene analysis: 0.31
3. Random gene analysis: 0.16

**NMI**

1. Standard analysis: 0.69
2. Marker gene analysis: 0.68
3. Random gene analysis: 0.45
...
1. Standard analysis: 0.50
2. Marker gene analysis: 0.56
3. Random gene analysis: 0.17

**NMI**

1. Standard analysis: 0.75
2. Marker gene analysis: 0.75
3. Random gene analysis: 0.33
...
1. Standard analysis: 0.50
2. Marker gene analysis: 0.50
3. Random gene analysis: 0.18

**NMI**

1. Standard analysis: 0.80
2. Marker gene analysis: 0.79
3. Random gene analysis: 0.41

### Discussion

Subsampling the data down to the union of the top 5 marker genes per cell type typically yields around 250-350 unique genes. If this set of genes were not enriched in biologically relevant genes, subsetting the data down to such a small number of genes would give very low quality results. This is evident in the random gene analysis results. Encouragingly, we do not observe any decrease in clustering accuracy when subsetting down to ~300 marker genes in any of the datasets tested.
