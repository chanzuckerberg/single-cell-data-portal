...
Tissues from all data that passed the <NextLink href="./4_2_3__Gene Expression Data Processing">pre-processing
filters</NextLink> are included in Gene Expression.

Tissue annotations provided by the original contributors come in different levels of granularity. For example, data
from Heart may come from the these annotations:
...
The table below shows current tissue mapping as of September 16, 2022.
