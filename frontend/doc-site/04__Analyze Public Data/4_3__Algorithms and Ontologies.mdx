...
- Create a 2-dimensional representation of the DAG using the dot method of graphiz. See [here](http://www.graphviz.org/pdf/dotguide.pdf) for a full description of this method.
