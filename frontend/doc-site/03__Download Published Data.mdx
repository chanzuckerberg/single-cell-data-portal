...
Clicking the download button launches a dialog that enables a dataset to be downloaded in h5ad (AnnData v0.7) and rds (Seurat v4) formats. All datasets adhere to the CELLxGENE single cell annotated data schema. Datasets can either be downloaded via the browser by clicking the blue download button, or via the command line by pasting the provided curl command.
