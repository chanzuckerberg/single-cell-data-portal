...
To read more about how to use gene sets in the cellxgene interface, please see [Creating a Geneset](https://docs.google.com/presentation/d/1ihFrKRSxnfFNexctOZ0EkUow9SWgEr-9TOVKvVLE8ms/edit#slide=id.gf4b1a39681_0_0)
...
<table>
  <tr>
    <th>gene\_set\_name</th>
    <th>gene\_set\_description</th>
    <th>gene\_symbol</th>
    <th>gene\_description</th>
  </tr>
  <tr>
    <td>club.cell</td>
    <td>description</td>
