...
The hosted data explorer allows you to *explore individual data sets* hosted on the CellxGene platform in UMAP form.

## ScEXPRESSION

[ScExpression](https://cellxgene.cziscience.com/scExpression) allows for an *exploration of gene expression by cell type across all data sets* in the CellxGene data corpus. It is currently in beta.
