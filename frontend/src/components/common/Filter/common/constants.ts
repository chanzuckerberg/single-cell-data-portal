...
const CATEGORY_FILTER_CONFIGS: CategoryFilterConfig[] = [
  ...
  },
  {
    ...
    label: "Organ",
    labelKind: "LOOKUP_LABEL_BY_TERM_ID",
    mask: TISSUE_ORGAN_PART_ONTOLOGY_TERM_SET,
    maskKind: "CURATED",
    matchKind: "INCLUDES_SOME",
    multiselect: true,
    queryKind: "EXCLUDES_SELF_AND_CHILDREN",
...
export const CATEGORY_FILTER_UI_CONFIGS: CategoryFilterUIConfig[] = [
  {
    categoryConfigKeys: [CATEGORY_FILTER_ID.ASSAY],
    label: "Assay",
  },
  {
    categoryConfigKeys: [CATEGORY_FILTER_ID.CELL_COUNT],
    label: "Cell Count",
  },
  {
    categoryConfigKeys: [CATEGORY_FILTER_ID.CELL_TYPE_DEPRECATED],
    label: "Cell Type",
  },
  {
    categoryConfigKeys: [CATEGORY_FILTER_ID.CELL_TYPE],
    label: "Cell Type (Ontology)",
  },
  {
    categoryConfigKeys: [CATEGORY_FILTER_ID.DEVELOPMENT_STAGE],
    label: "Development Stage",
  },
  {
    categoryConfigKeys: [CATEGORY_FILTER_ID.DISEASE],
    label: "Disease",
  },
  {
    categoryConfigKeys: [CATEGORY_FILTER_ID.ETHNICITY],
    label: "Ethnicity",
  },
  {
    categoryConfigKeys: [CATEGORY_FILTER_ID.GENE_COUNT],
    label: "Gene Count",
  },
  {
    categoryConfigKeys: [CATEGORY_FILTER_ID.ORGANISM],
    label: "Organism",
  },
  {
    categoryConfigKeys: [CATEGORY_FILTER_ID.PUBLICATION_AUTHORS],
    label: "Author",
  },
  {
    categoryConfigKeys: [CATEGORY_FILTER_ID.PUBLICATION_DATE_VALUES],
    label: "Publication Date",
  },
  {
    categoryConfigKeys: [CATEGORY_FILTER_ID.SEX],
    label: "Sex",
  },
  {
    categoryConfigKeys: [CATEGORY_FILTER_ID.TISSUE_DEPRECATED],
    label: "Tissue",
  },
  {
    categoryConfigKeys: [
