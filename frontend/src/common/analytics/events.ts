...
export enum EVENTS {
  ...
  CG_SEARCH_CT_TISSUE = "CG_SEARCH_CT_TISSUE", // done
  CG_TREE_NODE_CLICKED = "CG_TREE_NODE_CLICKED", // done
  CG_TREE_CELL_TYPE_CLICKED = "CG_TREE_CELL_TYPE_CLICKED", // done
  CG_VIEW_SECTION = "CG_VIEW_SECTION", // done
  CG_COPY_CELL_TYPE_DESCRIPTION = "CG_COPY_CELL_TYPE_DESCRIPTION",
  CG_CHAT_GPT_HOVER = "CG_CHAT_GPT_HOVER", // done
  CELL_GUIDE_CLICK_NAV = "CELL_GUIDE_CLICK_NAV",
  SUGGEST_CHANGE_CLICKED = "SUGGEST_CHANGE_CLICKED", // done
  CELL_GUIDE_CANONICAL_TAB_CLICKED = "CELL_GUIDE_CANONICAL_TAB_CLICKED", // done
  CELL_GUIDE_COMPUTATIONAL_TAB_CLICKED = "CELL_GUIDE_COMPUTATIONAL_TAB_CLICKED", // done
}
