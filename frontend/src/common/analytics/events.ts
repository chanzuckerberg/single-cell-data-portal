...
export enum EVENTS {
  ...
  NEWSLETTER_NO_SUBMIT_CLOSE_BUTTON_CLICKED = "NEWSLETTER_NO_SUBMIT_CLOSE_BUTTON_CLICKED",
  NEWSLETTER_SUBMIT_CLOSE_BUTTON_CLICKED = "NEWSLETTER_SUBMIT_CLOSE_BUTTON_CLICKED",
