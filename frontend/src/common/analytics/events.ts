...
export enum EVENTS {
  ...
  WMG_OPEN_IN_CELL_GUIDE_CLICKED = "WMG_OPEN_IN_CELL_GUIDE_CLICKED",
  ...
  CG_OPEN_IN_WMG_CLICKED = "CELL_GUIDE_OPEN_IN_WMG_CLICKED",
  CG_MARKER_GENE_PAGINATION_CLICKED = "CG_MARKER_GENE_PAGINATION_CLICKED",
  CG_DATA_COLLECTION_CLICKED = "CG_DATA_COLLECTION_CLICKED",
  CG_DATA_PUBLICATION_CLICKED = "CG_DATA_PUBLICATION_CLICKED",
