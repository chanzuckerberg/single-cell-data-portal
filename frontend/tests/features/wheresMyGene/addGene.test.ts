...
describe("Add gene tests", () => {
  ...
  test("Should select gene by copy pasting", async ({ page }) => {
    ...
    // github.com/microsoft/playwright/issues/8114
    // we will first write into search field, and then copy & paste
