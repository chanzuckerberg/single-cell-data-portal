...
API_URL = {
    "test": "https://corpora-api-test.dev.single-cell.czi.technology",
    "dev": "https://corpora-api.dev.single-cell.czi.technology",
}
...
class TestApi(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.auth0_secret = json.loads(AwsSecret("dcp/corpora/corpora/test/auth0-secret").value)
        cls.auth0_secret["audience"] = f"https://corpora-api.{os.getenv('DEPLOYMENT_STAGE')}.single-cell.czi.technology"
