...
class TestAuthToken(BaseAPITest):
    @patch("backend.corpora.lambdas.api.v1.curation.auth.token.CorporaAuthConfig")
    @patch("backend.corpora.lambdas.api.v1.curation.auth.token.auth0_management_session")
