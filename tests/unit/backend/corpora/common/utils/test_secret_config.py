...
class TestSecretConfig(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.secret_name = "corpora/bogo_component/{}/secrets".format(self.deployment_env)
    ...
    def test_from_file(self):
        with EnvironmentSetup({
            'CONFIG_SOURCE': fixture_file_path('bogo_config.js')
        }):
    ...
    def test_from_aws(self):
        with ExistingAwsSecretTestFixture(secret_name=self.secret_name,
                                          secret_value='{"secret1":"secret1_from_cloud"}'):
            with EnvironmentSetup({
                'CONFIG_SOURCE': None
            }):
    ...
    def test_custom_secret_name(self):
        custom_secret_name = "corpora/bogo_component/{}/custom-secret-name".format(self.deployment_env)
