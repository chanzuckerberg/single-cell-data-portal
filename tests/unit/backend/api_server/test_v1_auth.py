...
from tests.unit.backend.api_server.base_api_test import AuthServerAPITest
...
class TestAuth(AuthServerAPITest):
    ...
    def test__login_flow(self):
        ...
        # Test session cookie
        with self.subTest("Test session cookie"):
        ...
        with self.subTest("Test cxguser cookie"):
