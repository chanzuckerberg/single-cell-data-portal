...
class DeAPIV1Tests(unittest.TestCase):
    ...
    def test__differentialExpression_returns_expected_results(self, load_snapshot):
        expected_effect_size_sums = [
            [-299, 138, -269, 2654, 696, 2763, 2021],
            [-299, 138, -269, 2654, 696, 2763, 0],
            [-299, 138, -269, 2654, 696, 2763, 2836],
        ]
        expected_log_fold_change_sums = [
            [-73, 13, -52, 491, 199, 532, 483],
            [-73, 13, -52, 491, 199, 532, 0],
            [-73, 13, -52, 491, 199, 532, 500],
        ]
        expected_log_p_value_sums = [
            [596114, 157548, 276574, 125959, 134096, 69440, 123317],
            [596114, 157548, 276574, 125959, 134096, 69440, 0],
            [596114, 157548, 276574, 125959, 134096, 69440, 123599],
        ]
        expected_n_overlap = [
            [0, 0, 0, 0, 0, 0, 37],
            [0, 0, 0, 0, 0, 0, 37],
