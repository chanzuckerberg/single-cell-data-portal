...
class DeAPIV1Tests(unittest.TestCase):
    ...
    def test__differentialExpression_returns_expected_results(self, load_snapshot):
        expected_effect_size_sums = [
            [-291, 0, 0, 2654, 696, 2763, 2021],
            [-291, 0, 0, 2654, 696, 2763, 0],
            [-291, 0, 0, 2654, 696, 2763, 2836],
        ]
        expected_log_fold_change_sums = [
            [-73, 0, 0, 491, 199, 532, 483],
            [-73, 0, 0, 491, 199, 532, 0],
            [-73, 0, 0, 491, 199, 532, 500],
        ]
        expected_log_p_value_sums = [
            [595032, 0, 0, 125920, 134152, 69403, 123310],
            [595032, 0, 0, 125920, 134152, 69403, 0],
            [595032, 0, 0, 125920, 134152, 69403, 123592],
        ]
        expected_n_overlap = [
            [0, 0, 0, 0, 0, 0, 37],
            [0, 0, 0, 0, 0, 0, 37],
