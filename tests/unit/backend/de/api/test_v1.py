...
class DeAPIV1Tests(unittest.TestCase):
    ...
    def test__differentialExpression_returns_expected_results(self, load_snapshot):
        expected_effect_size_sums = [
            [-291, 0, -269, 2654, 696, 2763, 2021],
            [-291, 0, -269, 2654, 696, 2763, 0],
            [-291, 0, -269, 2654, 696, 2763, 2836],
        ]
        ...
        expected_log_p_value_sums = [
            [596114, 157548, 276574, 125920, 134152, 69403, 123317],
            [596114, 157548, 276574, 125920, 134152, 69403, 0],
            [596114, 157548, 276574, 125920, 134152, 69403, 123592],
        ]
        expected_n_overlap = [
            [0, 0, 0, 0, 0, 0, 37],
            [0, 0, 0, 0, 0, 0, 37],
