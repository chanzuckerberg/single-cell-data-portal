...
class TestDeleteDataset(BaseBusinessLogicTestCase):
    ...
    def test_delete_artifacts_artifact_type_doesnt_match_regex(self):
        ...
        artifacts: List[DatasetArtifact] = [
            DatasetArtifact(id=DatasetArtifactId(), type=DatasetArtifactType.CXG, uri=f"s3://{bucket}/{uuid_prefix}/file.h5ad"),
            DatasetArtifact(id=DatasetArtifactId(), type=DatasetArtifactType.H5AD, uri=f"s3://{bucket}/{uuid_prefix}/file.cxg/"),
        ]
        # Act
    ...
    def test_delete_artifacts_delete_cxg(self):
        ...
        # Arrange
        artifacts: List[DatasetArtifact] = [
            DatasetArtifact(id=DatasetArtifactId(), type=DatasetArtifactType.CXG, uri=f"s3://{bucket}/{uuid_prefix}/file.cxg/"),
        ]
        # Act
        delete_artifacts(artifacts)
        # Assert
    ...
    def test_delete_artifacts_with_rdev_prefix(self):
        ...
        # Arrange
        artifacts: List[DatasetArtifact] = [
            DatasetArtifact(id=DatasetArtifactId(), type=DatasetArtifactType.CXG, uri=f"s3://{bucket}/{rdev_prefix}/file.cxg/"),
        ]
        # Act
        delete_artifacts(artifacts)
        # Assert
    ...
    def test_delete_artifacts_delete_h5ad(self):
        ...
        # Arrange
        artifacts: List[DatasetArtifact] = [
            DatasetArtifact(id=DatasetArtifactId(), type=DatasetArtifactType.H5AD, uri=f"s3://{bucket}/{uuid_prefix}/file.h5ad"),
        ]
        # Act
        delete_artifacts(artifacts)
        # Assert
