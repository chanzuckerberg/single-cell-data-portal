...
class TestDatabase:
    ...
    def _create_test_collection_links(self):
        ...
        self.db_session.add(collection_link)
        ...
        self.db_session.add(collection_summary_link)
        self.db_session.commit()
    ...
    def _create_test_datasets(self):
        ...
        self.db_session.add(deployment_directory)
        self.db_session.commit()
    ...
    def _create_test_dataset_artifacts(self):
        ...
        self.db_session.add(dataset_artifact)
        self.db_session.commit()
    ...
    def _create_test_dataset_processing_status(self):
        ...
        self.db_session.add(dataset_processing_status)
        self.db_session.commit()
