...
from backend.api.data_portal.lambdas.cloudfront_invalidator.cloudfront import (
...
class TestCloudfront(TestCase):
    @mock.patch("backend.api.data_portal.lambdas.cloudfront_invalidator.cloudfront._cloudfront_client")
