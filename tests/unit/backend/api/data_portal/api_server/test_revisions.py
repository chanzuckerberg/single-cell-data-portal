...
from backend.api.data_portal.common.corpora_orm import CollectionVisibility, ConversionStatus, DatasetArtifactFileType
from backend.api.data_portal.common.entities import Dataset, Collection
from backend.api.data_portal.common.utils.db_session import db_session_manager
...
class TestPublishRevision(BaseRevisionTest):
    ...
    def publish_collection(self, collection_id: str) -> dict:
        ...
        with patch("backend.api.data_portal.common.entities.collection.datetime") as mock_dt:
