...
class TestSecretConfig(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.patcher = patch("backend.api.data_portal.common.utils.aws.boto3.client")
    ...
    def test_singletonness(self):
        with patch(
            "backend.api.data_portal.common.utils.aws.AwsSecret.value", new_callable=PropertyMock
