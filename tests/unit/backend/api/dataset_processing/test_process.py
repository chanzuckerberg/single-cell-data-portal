...
from backend.api.data_portal.common.entities import Collection, Dataset

from backend.api.data_portal.common.utils.exceptions import CorporaException
from backend.api.data_portal.dataset_processing import process
from backend.api.data_portal.dataset_processing.exceptions import ProcessingCancelled
from backend.api.data_portal.dataset_processing.process import download_from_dropbox_url, convert_file_ignore_exceptions
...
class TestDatasetProcessing(DataPortalTestCase):
    ...
    @patch("backend.api.data_portal.dataset_processing.process.make_cxg")
    @patch("backend.api.data_portal.dataset_processing.process.subprocess.run")
    ...
    @patch("backend.api.data_portal.dataset_processing.process.make_seurat")
    ...
    @patch("backend.api.data_portal.dataset_processing.process.update_db")
    ...
    @patch("backend.api.data_portal.dataset_processing.download.downloader")
    @patch("backend.api.data_portal.dataset_processing.process.from_url")
    ...
    @patch("backend.api.data_portal.dataset_processing.process.make_cxg")
    @patch("backend.api.data_portal.dataset_processing.process.download_from_dropbox_url")
    @patch("backend.api.data_portal.dataset_processing.process.validate_h5ad_file_and_add_labels")
    @patch("backend.api.data_portal.dataset_processing.process.extract_metadata")
    ...
    @patch("backend.api.data_portal.dataset_processing.process.make_seurat")
    @patch("backend.api.data_portal.dataset_processing.process.create_artifact")
    @patch("backend.api.data_portal.dataset_processing.process.update_db")
