...
from backend.api.data_portal.common.corpora_orm import UploadStatus
...
from backend.api.data_portal.dataset_processing import download
from backend.api.data_portal.dataset_processing.exceptions import ProcessingFailed
...
class TestDownload(DataPortalTestCase):
    ...
    def setUpClass(cls):
        ...
        cls.server_process = multiprocessing.Process(
            target=start_server, args=("tests/unit/backend/api/fixtures", cls.port), daemon=True
        )
