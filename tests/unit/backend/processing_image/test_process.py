...
from backend.corpora.dataset_processing.process import convert_file_ignore_exceptions, download_from_dropbox_url, make_cxg, \
    make_seurat, make_loom
...
class TestDatasetProcessing(DataPortalTestCase):
    ...
    def setUpClass(cls):
        ...
        presigned_url = cls.get_presigned_url("a5da03d7-f44b-4bb8-81a4-bc80960d6223", "04be802c-ffc6-4a7f-a4c5-f2812f1a707f")
    ...
    def test_main(self, mock_get_download_url_from_shared_link):
        url = self.get_presigned_url("a5da03d7-f44b-4bb8-81a4-bc80960d6223",
                                                       "04be802c-ffc6-4a7f-a4c5-f2812f1a707f")
        ...
        with EnvironmentSetup(
                {'DROPBOX_URL': url,
                 'ARTIFACT_BUCKET': "s3://artifacts", 'CELLXGENE_BUCKET': 's3://cellxgene',
                 'DATASET_ID': dataset.id}):
            process.main()
