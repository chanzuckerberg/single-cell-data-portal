...
from tests.unit.backend.apps.fixtures.existing_aws_secret_test_fixture import ExistingAwsSecretTestFixture

from backend.apps.common.utils.secret_config import SecretConfig
from backend.apps.common.utils.aws import AwsSecret
...
class TestSecretConfig(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.patcher = patch("backend.apps.common.utils.aws.boto3.client")
    ...
    def test_singletonness(self):
        with patch("backend.apps.common.utils.aws.AwsSecret.value", new_callable=PropertyMock) as mock_aws_secret_value:
