...
from backend.apps.common.providers.crossref_provider import (
    CrossrefException,
...
class TestCrossrefProvider(unittest.TestCase):
    @patch("backend.apps.common.providers.crossref_provider.requests.get")
    ...
    @patch("backend.apps.common.providers.crossref_provider.requests.get")
    @patch("backend.apps.common.providers.crossref_provider.CorporaConfig")
