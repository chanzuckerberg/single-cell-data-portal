...
from backend.apps.common.corpora_orm import CollectionVisibility, ProcessingStatus
from backend.apps.common.entities import Dataset
from backend.apps.common.utils.math_utils import GB
from tests.unit.backend.apps.api_server.base_api_test import BaseAuthAPITest, BasicAuthAPITestCurator
from tests.unit.backend.apps.api_server.mock_auth import get_auth_token
from tests.unit.backend.apps.fixtures.environment_setup import EnvironmentSetup, fixture_file_path
...
class TestCollectionPostUploadLink(BaseAuthAPITest):
    ...
    @patch("backend.apps.common.upload_sfn.start_upload_sfn")
    ...
    @patch(
        "backend.apps.common.utils.dl_sources.url.DropBoxURL.file_info",
    ...
    @patch(
        "backend.apps.common.utils.dl_sources.url.DropBoxURL.file_info", return_value={"size": 1, "name": "file.txt"}
    )
