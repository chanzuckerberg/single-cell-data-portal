...
from backend.apps.common.corpora_orm import CollectionVisibility, ConversionStatus, DatasetArtifactFileType
from backend.apps.common.entities import Dataset, Collection
...
from tests.unit.backend.apps.api_server.base_api_test import BaseAuthAPITest
...
class TestPublishRevision(BaseRevisionTest):
    ...
    def publish_collection(self, collection_id: str) -> dict:
        ...
        with patch("backend.apps.common.entities.collection.datetime") as mock_dt:
