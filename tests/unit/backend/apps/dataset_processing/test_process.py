...
from backend.apps.common.utils.exceptions import CorporaException
from backend.apps.dataset_processing.exceptions import ProcessingCancelled
...
class TestDatasetProcessing(DataPortalTestCase):
    ...
    @patch("backend.apps.dataset_processing.process.make_cxg")
    @patch("backend.apps.dataset_processing.process.subprocess.run")
    ...
    @patch("backend.apps.dataset_processing.process.make_seurat")
    ...
    @patch("backend.apps.dataset_processing.process.update_db")
    ...
    @patch("backend.apps.dataset_processing.download.downloader")
    @patch("backend.apps.dataset_processing.process.from_url")
    ...
    @patch("backend.apps.dataset_processing.process.validate_h5ad_file_and_add_labels")
    @patch("backend.apps.dataset_processing.process.extract_metadata")
    ...
    @patch("backend.apps.dataset_processing.process.make_seurat")
    @patch("backend.apps.dataset_processing.process.create_artifact")
    @patch("backend.apps.dataset_processing.process.update_db")
