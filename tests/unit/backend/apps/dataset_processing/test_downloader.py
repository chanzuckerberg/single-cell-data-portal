...
from backend.apps.common.corpora_orm import UploadStatus
from backend.apps.common.entities import Dataset
from backend.apps.common.utils.math_utils import MB
from backend.apps.dataset_processing import download
from backend.apps.dataset_processing.exceptions import ProcessingFailed
...
class TestDownload(DataPortalTestCase):
    ...
    def setUpClass(cls):
        ...
        cls.server_process = multiprocessing.Process(
            target=start_server, args=("tests/unit/backend/apps/fixtures", cls.port), daemon=True
        )
