        ...
        with create_temp_wmg_snapshot(
            ...
            with self.subTest("when a secondary dimension has criteria, it's own values are not restricted"):
                ...
                filter_0_no_dev_stage_request = dict(
                    filter=filter_0_no_dev_stage_filter, include_filter_dims=True, is_rollup=False
                )
                ...
                filter_0_no_ethnicity_request = dict(
                    filter=filter_0_no_ethnicity_filter, include_filter_dims=True, is_rollup=False
                )
            ...
            with self.subTest(
                ...
                self_reported_ethnicity_0_request = dict(
                    filter=self_reported_ethnicity_0_filter, include_filter_dims=True, is_rollup=False
                )
                ...
                self_reported_ethnicity_1_request = dict(
                    filter=self_reported_ethnicity_1_filter, include_filter_dims=True, is_rollup=False
                )
                ...
                self_reported_ethnicity_1_dev_1_request = dict(
                    filter=self_reported_ethnicity_1_dev_1_filter, include_filter_dims=True, is_rollup=False
                )
                ...
                self_reported_ethnicity_2_request = dict(
                    filter=self_reported_ethnicity_2_filter, include_filter_dims=True, is_rollup=False
                )
                eth_2_dev_2_request = dict(
                    filter=self_reported_ethnicity_2_dev_2_filter, include_filter_dims=True, is_rollup=False
                )
