...
class QueryTest(unittest.TestCase):
    def test__query_marker_genes_cube__returns_correct_top_10_markers(self):
        ...
        with load_test_fmg_snapshot(TEST_SNAPSHOT) as snapshot:
            ...
            expected = {
                ...
                "ENSG00000180879": {"p_value": 0.0, "effect_size": 2.5837366580963135},
                "ENSG00000132465": {"p_value": 0.0, "effect_size": 2.3984060287475586},
                "ENSG00000134285": {"p_value": 0.0, "effect_size": 1.860002875328064},
                ...
                "ENSG00000211592": {"p_value": 0.0, "effect_size": 1.486777663230896},
    ...
    def test__query_marker_genes_cube__returns_correct_all_markers(self):
        ...
        with load_test_fmg_snapshot(TEST_SNAPSHOT) as snapshot:
            ...
            expected = {
                "ENSG00000125844": {"p_value": 7.384380478498559e-40, "effect_size": 0.41275840997695923},
                "ENSG00000171311": {"p_value": 0.00026773425634019077, "effect_size": 0.14243963360786438},
                "ENSG00000099958": {"p_value": 0.0, "effect_size": 1.6013718843460083},
                "ENSG00000100219": {"p_value": 0.0, "effect_size": 1.4613032341003418},
                "ENSG00000102158": {"p_value": 9.539967140881345e-05, "effect_size": 0.13596965372562408},
                "ENSG00000170542": {"p_value": 1.0, "effect_size": 0.0},
                "ENSG00000132465": {"p_value": 0.0, "effect_size": 2.3984060287475586},
                "ENSG00000186818": {"p_value": 1.1913300113519654e-05, "effect_size": 0.21295301616191864},
                "ENSG00000166562": {"p_value": 0.0, "effect_size": 1.8400332927703857},
                "ENSG00000118363": {"p_value": 0.0, "effect_size": 1.4760183095932007},
                "ENSG00000102007": {"p_value": 1.6618587033783022e-39, "effect_size": 0.25518468022346497},
                "ENSG00000134970": {"p_value": 0.0032371620181947947, "effect_size": 0.08548668771982193},
                "ENSG00000173110": {"p_value": 4.1021425423249675e-21, "effect_size": 0.3918844759464264},
                "ENSG00000180879": {"p_value": 0.0, "effect_size": 2.5837366580963135},
                "ENSG00000170476": {"p_value": 0.0, "effect_size": 2.8502309322357178},
                "ENSG00000134285": {"p_value": 0.0, "effect_size": 1.860002875328064},
                "ENSG00000211592": {"p_value": 0.0, "effect_size": 1.486777663230896},
                "ENSG00000031698": {"p_value": 1.480379374640961e-08, "effect_size": 0.047324057668447495},
                "ENSG00000051108": {"p_value": 0.0, "effect_size": 1.6856228113174438},
            }
            self.assertDictEqual(marker_genes, expected)
