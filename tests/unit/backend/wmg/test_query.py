...
class QueryTest(unittest.TestCase):
    ...
    def test__query_agg_cell_type_counts__returns_correct_result(self):
        ...
        expected = (
            [{"n_cells_cell_type": 2187 * expected_count, "n_cells_cell_type_raw": 2187 * expected_count}]
