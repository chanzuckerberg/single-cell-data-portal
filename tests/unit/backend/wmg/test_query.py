...
class QueryTest(unittest.TestCase):
    def test__query_with_no_genes__returns_empty_result(self):
        ...
        with create_temp_wmg_cubes(dim_size=dim_size,
                                   expression_summary_vals_fn=all_ones_expression_summary_values) as cubes:
    ...
    def test__query_all_indexed_dims_single_value__returns_correct_result(self):
        ...
        self.assertEqual(expected, sorted(result.to_dict('records'),
                                          key=lambda r: (r['gene_ontology_term_id'],
