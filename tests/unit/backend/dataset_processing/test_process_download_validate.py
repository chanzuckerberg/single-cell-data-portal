...
class TestProcessingDownloadValidate(DataPortalTestCase):
    ...
    @patch("backend.portal.pipeline.processing.download.downloader")
    @patch("backend.portal.pipeline.processing.process_download_validate.from_url")
    ...
    @mock_s3
    @patch("backend.portal.pipeline.processing.process_download_validate.download_from_s3")
