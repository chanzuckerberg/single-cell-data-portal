...
from backend.wmg.data.snapshot import CELL_COUNTS_DIFFEXP_CUBE_NAME, EXPRESSION_SUMMARY_DIFFEXP_CUBE_NAME
...
class ExpressionSummaryDiffexpTests(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for cube_name in [EXPRESSION_SUMMARY_DIFFEXP_CUBE_NAME, CELL_COUNTS_DIFFEXP_CUBE_NAME]:
